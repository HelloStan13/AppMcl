...
public class DespacharProductosporMayor extends Command {
    ...
    public DespacharProductosporMayor(AlmacenamientoId almacenamientoId, DespachoAVentasId despachoAVentaId, Planilla planilla) {
